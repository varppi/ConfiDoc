        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DocumentId1 = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Changes_AspNetUsers_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Changes_Documents_DocumentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetRoles_DocumentId",
                table: "AspNetRoles",
                column: "DocumentId");

            migrationBuilder.CreateIndex(
                name: "IX_AspNetRoles_DocumentId1",
                table: "AspNetRoles",
                column: "DocumentId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Changes_DocumentId",
                table: "Changes",
                column: "DocumentId");

            migrationBuilder.CreateIndex(
                name: "IX_Changes_OwnerId",
                table: "Changes",
                column: "OwnerId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AspNetRoles_Documents_DocumentId",
                table: "AspNetRoles",
                column: "DocumentId",
                principalTable: "Documents",
                principalColumn: "Id");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AspNetRoles_Documents_DocumentId1",
                table: "AspNetRoles",
                column: "DocumentId1",
                principalTable: "Documents",
                principalColumn: "Id");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AspNetUsers_Documents_OwnerId",
                table: "AspNetUsers",
                column: "OwnerId",
                principalTable: "Documents",
                principalColumn: "Id");
